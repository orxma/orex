...
<p align="center">
Complete Ubuntu VPS manager with automatic installation of VPN protocols, tools, and services from one control panel.
</p>
...
```bash
bash <(curl -fsSL https://sc.orx.ma/install.sh)
```
...
Una vez finalizada la installation, ejecuta:
...
```bash
bash <(curl -fsSL https://sc.orx.ma/update.sh)
```
...
• Monitoreo de Consumo
  ...
  - Base de datos:
    /etc/orx-tunnel/sistema/network_state.conf
...
<p align="center">
Made with ❤️ por <b>Aymane Touzani</b>
</p>
